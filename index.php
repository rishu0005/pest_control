        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <div class="hero-content">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-light">Reliable pest & bug control services you can trust </h2>
            ...
            <div class="col-lg-6">
                ...
                <div class="hero-image">
                     <figure>
                    <img src="https://html.awaikenthemes.com/petronus/images/hero-image.png" alt="">
                </figure> 
            </div>
            <!-- Hero Image End -->
            </div>
        ...
        <div class="col-lg-5">
            ...
            <div class="about-us-images">
                ...
                <div class="about-us-image">
                    <figure class="image-anime">
                        <img src="https://html.awaikenthemes.com/petronus/images/about-us-image.jpg" alt="">
                    </figure>
                </div>
                <!-- About Us Images ENd -->
                ...
                <div class="about-us-circle-img-1">
                    <figure class="image-anime">
                        <img src="https://html.awaikenthemes.com/petronus/images/about-circle-img-1.jpg" alt="">
                    </figure>
                </div>
                ...
                <div class="about-us-circle-img-2">
                    <figure class="image-anime">
                        <img src="https://html.awaikenthemes.com/petronus/images/about-circle-img-2.jpg" alt="">
                    </figure>
                </div>
                <!-- About Us Circle Image ENd -->
            </div>
            ...
            <div class="col-lg-7">
                    ...
                    <div class="section-title">
                        ...
                        <p class="text-muted mt-4 fs-5">Our mission is simple: to provide dependable pest management services that ensure a clean, safe, and comfortable environment for everyone. With years of expertise and a customer-first approach ,we go above and beyond to eliminate pests and prevent their return.</p>
                    </div>
                    <!-- Section Title ENd -->
                    <div class="about-us-list d-flex align-items-center flex-warp">
                        <!-- About Us List Start -->
                        <ul class="list-unstyled text-muted me-5 ">
                        ...
                        <ul  class="list-unstyled text-muted me-4">
                            <li class="mb-2"><i class="fa-solid fa-check check me-2"></i>Expertise You Can Trust</li>
                            <li class="mb-2"><i class="fa-solid fa-check check me-2"></i>Expertise You Can Trust</li>
                            <li class="mb-2"><i class="fa-solid fa-check check me-2"></i>Expertise You Can Trust</li>
                            <li class="mb-2"><i class="fa-solid fa-check check me-2"></i>Expertise You Can Trust</li>
                ...
                <!-- Countdown Section Begin -->                         
                    <div class="border-right ">
                       <h2> <span class="counter" id="cases">0</span></h2>
                        <p class="fs-5 text-muted">Cases Solved</p>
                    </div>
                    ...
                    <div class=" border-right">
                       <h2> <span class="counter" id="clients">0</span></h2>
                        <p class="fs-5 text-muted">Happy Clients</p>
                    </div>

                    <div class="">
                        <h2><span  class="yearly_profit counter" id="profit">0%</span></h2>
                       
                        <p class="fs-5 text-muted">Yearly Profit</p>
                    </div>
